/**
 * Implémentation de l'interface GrilleFactory pour créer des instances de Grille.
 */
public class GrilleFactoryImpl implements GrilleFactory {
     ...
     */
    @Override
    public Grille buildGrille(ElementDeGrille[] elementDeGrilles,
     ElementDeGrille[][] grille) throws ElementInterditException,
     ValeurInitialeModificationException,
     HorsBornesException,
     ValeurImpossibleException {

        return new GrilleImpl(grille);
    }
}
